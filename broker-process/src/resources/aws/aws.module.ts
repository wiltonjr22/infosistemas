...
import { SQS_QUEUES, SQS_QUEUE_ENV_NAMES } from "./dtos/sqs-queues";
...
@Module({
  imports: [
    ...
    SqsModule.registerAsync({
      ...
      useFactory: async (configService: ConfigService) => {
        ...
        const producers = Object.entries(SQS_QUEUES).map(([key, value]) => {
          ...
          logger.log(`Configuring queue: ${key} with URL: ${queueUrl}`);
  ...
  exports: [AwsSqsService, SqsModule],
})
